                ...
                <div className="grid w-full max-w-full py-8 mx-auto gap-4 xl:gap-0 lg:py-16 lg:grid-cols-12">
                    <div className="mr-auto place-self-center md:col-span-6 w-full mb-10">
                        <form className="w-full max-w-full px-10 md:px-20">
                            ...
                            <input type="email" id="email" class="mb-5 bg-gray-50 border border-purple-300 text-gray-900 text-sm rounded-lg focus:ring-purple-500 focus:border-purple-500 block w-full px-5 py-3" placeholder="Email" required />
                            ...
                            <div className="pl-4 pr-3 pb-4">
                                <input type="checkbox" name="" id="" className="w-4 h-4" required />
                                <span className="font-xs text-gray-600"> I agree to Perpus Booking’s Terms and Service, Privacy Policy, and Notification Settings.</span>
                            </div>
                            <button
                                type="button"
